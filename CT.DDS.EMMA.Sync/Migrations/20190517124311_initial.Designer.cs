...
namespace CT.DDS.EMMA.Sync.Migrations
{
    ...
    [Migration("20190517124311_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CT.DDS.EMMA.Sync.Models.Execution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CT.DDS.EMMA.Sync.Models.JobConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CT.DDS.EMMA.Sync.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CT.DDS.EMMA.Sync.Models.SmtpConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CT.DDS.EMMA.Sync.Models.Execution", b =>
                {
                    b.HasOne("CT.DDS.EMMA.Sync.Models.JobConfig", "JobConfig")
                        .WithMany()
                        .HasForeignKey("JobConfigId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CT.DDS.EMMA.Sync.Models.SmtpConfig", "SmtpConfig")
                        .WithMany()
            ...
            modelBuilder.Entity("CT.DDS.EMMA.Sync.Models.Message", b =>
                {
                    b.HasOne("CT.DDS.EMMA.Sync.Models.Execution")
